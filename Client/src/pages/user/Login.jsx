...
const Login = () => {
    ...
    return (
        <div className='mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8'>
           <h1 className='text-2xl font-bold text-secondary sm:text-3xl text-center'>Get Stated today</h1>
             ...
             <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <span className='absolute inset-y-0 end-0 grid place-content-center px-4'><MdOutlineRemoveRedEye onClick={() => setShowPassword(!showPassword)} className='h-4 w-4 text-gray-400'/></span>
                    </div>
                </div>
