...
const Navbar = () => {
    ...
    return (
        ...
        className={`${isHome ? navBg : "bg-white dark:dg-black backdrop-blur-2xl"} ${isFixed ? 'static' : 'fixed'} top-0 transition-colors duration-500 ease-in-out w-full z-10`}>
                            ...
                            <ul className='ml-10 flex items-center space-x-4 pr-4'>
                                {
                                    navLinks.map((link) => (
                                        <li key={link.route}>
                                            <NavLink to={link.route} style={{whiteSpace: "nowrap"}}
                                                className={({ isActive }) =>
                                ...
                                {
                                    user && <li>
                                        <img src={photoURL} alt="profile" className='h-[40px] rounded-full w-[40px] '/>
                                    </li>
                                }

                                {
                                    user && <li><NavLink onClick={handleLogout}className={'font-bold px-3 py-3 bg-secondary text-white rounded-xl'}>Logout</NavLink></li>
                                }
